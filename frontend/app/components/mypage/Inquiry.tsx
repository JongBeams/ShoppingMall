          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 border border-gray-300 bg-white py-2.5 text-sm font-medium text-gray-700 transition hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
              >
                취소
              </button>
              <button
                type="submit"
                className="flex-1 border border-gray-900 bg-gray-900 py-2.5 text-sm font-medium text-white transition hover:bg-gray-800 dark:border-white dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100"
              >
                문의 등록
              </button>
            </div>
      ...
      <div className="space-y-3">
        {inquiries.length > 0 ? (
                  ...
                  {inquiry.admin_reply ? (
                    <div>
                      ...
                      <div className="rounded border border-green-200 bg-green-50 p-3 dark:border-green-800 dark:bg-green-950">
                        <p className="text-sm text-gray-700 dark:text-gray-300 whitespace-pre-wrap">{inquiry.admin_reply}</p>
                        {inquiry.replied_at && (
                    ...
                    <div className="rounded border border-yellow-200 bg-yellow-50 p-3 text-sm text-yellow-800 dark:border-yellow-800 dark:bg-yellow-950 dark:text-yellow-200">
                      관리자 답변을 기다리고 있습니다.
                    </div>
                  )}
                </div>
          ...
          <div className="border border-gray-200 bg-white p-12 text-center dark:border-gray-700 dark:bg-gray-800">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">등록된 문의가 없습니다</p>
