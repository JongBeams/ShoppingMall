  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
        <div>
          <h2 className="text-lg font-bold text-gray-900 dark:text-white">찜한 상품</h2>
      ...
      {dummyWishList.length === 0 ? (
        <div className="border border-gray-200 bg-white p-12 text-center dark:border-gray-700 dark:bg-gray-800">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">찜한 상품이 없습니다</p>
          <p className="mt-1 text-xs text-gray-400">마음에 드는 상품을 찜해보세요.</p>
        </div>
      ) : (
        <div className="space-y-3">
          {dummyWishList.map((product) => (
            <div key={product.id} className="flex gap-4 border border-gray-200 bg-white p-4 transition hover:shadow-sm dark:border-gray-700 dark:bg-gray-800">
              {/* Product Image */}
              <div className="relative h-24 w-24 flex-shrink-0 overflow-hidden border border-gray-200 bg-gray-100 dark:border-gray-700 dark:bg-gray-700">
